...
//  AppStore
//
//  Created by Mukhit Moldir on 02.12.2023.
//
...
class TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        viewControllers = [
            createController(viewController: MainViewController(collectionViewLayout: UICollectionViewFlowLayout()), title: "Main", imageName: "today_icon"),
